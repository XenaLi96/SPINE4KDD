...
\begin{figure*}[p]
\centering
\includegraphics[width=0.86\linewidth]{main_exp.png}
...
\label{fig:main_exp}
\vspace{4pt}
\captionof{table}{\textbf{Validation across exact, controlled synthetic, and Spot level spatial perturbation datasets.}
...
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lrrlr@{}}
\toprule
\multicolumn{3}{c}{\textbf{A. Independent split}} &
\multicolumn{2}{c}{\textbf{B. Input controls}} \\
\cmidrule(lr){1-3}\cmidrule(l){4-5}
Metric & Base & Full/effect & Profile / region & Ring $r$ \\
\midrule
Pooled Ring & 0.3626 & 0.4111 & Correct / correct & 0.4574 \\
Paired lift & -- & $+0.0532$ & Shuffled / correct & 0.4056 \\
95\% CI & -- & [0.0474, 0.0586] & Correct / relocated & 0.4314 \\
Predictive $R^2$ & 0.3712 & 0.4669 & Random / random & 0.4135 \\
Partial $R^2$ & -- & 0.1521 & Correct / random CCC & 0.4575 \\
95\% CI & -- & [0.1476, 0.1559] & & \\
\bottomrule
\end{tabular*}
\end{minipage}
...
\midrule
Gene-disjoint match/output & $+0.0257$ & [0.0215, 0.0302] \\
No center expression & $+0.0281$ & [0.0244, 0.0319] \\
No patch expression & $+0.0263$ & [0.0226, 0.0300] \\
No expression & $+0.0128$ & [0.0088, 0.0166] \\
...
\end{minipage}
\vspace{3pt}
\parbox{0.98\linewidth}{\footnotesize\textit{Reading.}
...
held-out burden. This is a retrospective perturbation-ranking result, not a
treatment recommendation. Prospective validation should select actions before
...
and selector results are retrospective. Prospective spatial perturbation
