...
Pooled correlation rewards stable anatomy; graph-paired Ring lift tests whether
the correct seed reorganizes the local field beyond context. Their disagreement
identifies direct-effect transfer and top-action calibration as the remaining
bottlenecks.
...
held-out burden. The utility--burden interface ranks drug--dose--time
actions in observed LINCS, Tahoe-100M, and Sci-Plex profiles. We therefore view
\methodname{} as a response-field-based selector for experimental
prioritization. Evidence remains retrospective; undesirable-program scores are
...
Primary estimates come from one mouse-brain assay; scale, programs, and
calibration may not transfer across tissues or platforms. Guide-OOD gains are
...
required; public data remain subject to their original terms.
