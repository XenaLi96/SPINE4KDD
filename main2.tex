...
collects the corresponding variance, matching, input-control, transfer, and
scale diagnostics.
...
transfer diagnostics.} Panels A, C, and E use the strict three-way spatial
...
\vspace{2pt}
\begin{minipage}[t][6.1cm][s]{0.49\linewidth}
\centering
\scriptsize
...
\vfill
\textbf{D. Five-fold guide-OOD seed transfer}
\vspace{1pt}
\resizebox{\linewidth}{!}{%
\begin{tabular}{lrrrr}
\toprule
...
External scRNA seed & 0.4400 & 0.4130 & $-0.0270$ & 5/5 below zero \\
\bottomrule
\end{tabular}}

\vfill
\textbf{E. Patch-scale sensitivity}
\vspace{1pt}
...
matching does not. Assay-matched spatial seeds improve all five guide-OOD
folds; external scRNA seeds underperform zero seed in all five. Larger patches
have higher context predictability but not stronger perturbation-conditioned
signal.}
\end{table*}
...
\begin{table*}[t]
\centering
\caption{Input-effect and structural diagnostics on controlled synthetic and
real benchmarks.}
